...
export default function PostDetailPage() {
  ...
  useEffect(() => { fetch(`/api/posts/${params.id}/comments`).then(response => response.ok ? response.json() : Promise.reject()).then(data => setComments(data.comments)).catch(() => undefined); }, [params.id]);
